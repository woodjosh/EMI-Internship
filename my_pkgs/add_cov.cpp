...
public:
  ...
  void callback(const geometry_msgs::PoseStamped& input)
  {
    ...
    output.pose.covariance[0] = 0.1; 
    output.pose.covariance[7] = 0.1; 
    output.pose.covariance[14] = 0.1;
    output.pose.covariance[21] = 0.1;
    output.pose.covariance[28] = 0.1;
    output.pose.covariance[35] = 0.1;
    pub_.publish(output);
  }
